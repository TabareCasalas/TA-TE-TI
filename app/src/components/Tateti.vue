...
export default {
  ...
  methods: {
    ...
    gameStatus() {
      ...
      if (
        (this.boardStatus[0] == 1 || this.boardStatus[0] == 2) &&
        (this.boardStatus[1] == 1 || this.boardStatus[1] == 2) &&
        (this.boardStatus[2] == 1 || this.boardStatus[2] == 2) &&
        (this.boardStatus[3] == 1 || this.boardStatus[3] == 2) &&
        (this.boardStatus[4] == 1 || this.boardStatus[4] == 2) &&
        (this.boardStatus[5] == 1 || this.boardStatus[5] == 2) &&
        (this.boardStatus[6] == 1 || this.boardStatus[6] == 2) &&
        (this.boardStatus[7] == 1 || this.boardStatus[7] == 2) &&
        (this.boardStatus[8] == 1 || this.boardStatus[8] == 2)) {
          this.gameOver = true;
          this.winer = true
          this.$emit('ningunogana')
          } 
    },
    reset() {
